          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-in-up delay-300">
              <button 
                ...
                className="bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-lg font-semibold hover:from-red-700 hover:to-red-800 transition-all duration-300 transform hover:scale-105 flex items-center justify-center group"
              >
            ...
            {/* Next Event Info */}
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 animate-fade-in-up delay-500">
              <h3 className="text-lg font-semibold text-white mb-4">Next Event:</h3>
