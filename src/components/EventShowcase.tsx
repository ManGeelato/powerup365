  ...
  const upcomingEvents = [
    {
      ...
      time: "18:00 - 21:00",
      location: "46 Arbroath Road, Bedfordview",
      attendees: 150,
      price: "R350",
      description: "Join us for an evening of powerful networking, inspiring conversations, and meaningful connections that will elevate your business to new heights.",
